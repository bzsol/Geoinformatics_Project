import { MapContainer, TileLayer, Marker, Popup, LayersControl, Polyline, Polygon, Circle, Rectangle, ImageOverlay, LayerGroup } from "react-leaflet";
...
function MapComp() {
    ...
    const bounds = [[47.94910168348338, 21.700286393452984], [47.94508095662391, 21.70794504683866]]
    const bujtos = [
        [
            47.964192391523426,
            21.72627528375932,
        ...
        <div>
            ...
            >
                ...
                <LayersControl position="topright">
                    ...
                    <LayersControl.Overlay name="Nyíregyházi ALDI-k">
                        <LayerGroup>
                            {aldi.map((item) => (
                    ...
                    <LayersControl.Overlay name="Gyros lelőhelyek">
                        <LayerGroup>
                    ...
                    <LayersControl.Overlay name="Vasútállomást jelző átfedő kép">
                        <LayerGroup>
                            <ImageOverlay
                                url="mav.png"
                                bounds={bounds}
                    ...
                    <LayersControl.Overlay name="Belvárost átfedő polygon">
                        <LayerGroup>
                        <Polygon pathOptions={fillBlueOptions} positions={old_town} />
                        </LayerGroup>
                    </LayersControl.Overlay>
                    <LayersControl.Overlay name="Örökösföldet átfedő polygon">
                        <LayerGroup>
                        <Polygon pathOptions={fillGreenOptions} positions={orokosfold} />
                        </LayerGroup>
                    </LayersControl.Overlay>
                    <LayersControl.Overlay name="Új körút négysávos fejlesztése (Polyline)">
                        <LayerGroup>
                        <Polyline pathOptions={purpleOptions} positions={line} />
                        </LayerGroup>
                    </LayersControl.Overlay>
                    <LayersControl.Overlay name="Kórházt jelölő Circle">
                        <LayerGroup>
                        <Circle center={[47.951259618630644, 21.73052609092042]} radius={200} pathOptions={{ color: 'red' }} />
                        </LayerGroup>
                    </LayersControl.Overlay>
                    <LayersControl.Overlay name="Bujtosi parkot jelölő téglalap">
                        <LayerGroup>
